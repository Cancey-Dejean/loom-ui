  ...
  return (
    <div
      className={classNames(
        ...
        "[&_img]:h-full  [&_img]:w-full object-cover"
      )}
    >
      <div>
        <svg
        ...
        >
          ...
          <g className="RecordScreenSchedule_remove5__7ZG7t">
            <line
              stroke="#3b2d5e"
              x1="71.2"
              x2="690.3"
          ...
          <g className="RecordScreenSchedule_remove4__joiks">
            <path
          ...
          <g className="RecordScreenSchedule_remove3__mtjf_">
            <line
              stroke="#3b2d5e"
              x1="71.2"
              x2="690.3"
          ...
          <g className="RecordScreenSchedule_remove2__MgGdt">
            <path
        ...
        {/* <img src="https://dummyimage.com/2020x1136.png/dddddd/ffffff" alt="" /> */}
      </div>
      CardImageVideo
    </div>
  )
